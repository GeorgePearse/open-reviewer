...
describe("redactGitHubTokens", () => {
  it("should redact personal access tokens (ghp_)", () => {
    const token = "ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW";
  ...
  it("should redact OAuth tokens (gho_)", () => {
    const token = "gho_EXAMPLE16C7e42F292c6912E7710c838347Ae178B4a";
  ...
  it("should redact installation tokens (ghs_)", () => {
    const token = "ghs_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW";
  ...
  it("should redact refresh tokens (ghr_)", () => {
    const token = "ghr_EXAMPLE1B4a2e77838347a253e56d7b5253e7d11667";
  ...
  it("should redact fine-grained tokens (github_pat_)", () => {
    const token =
      "github_pat_EXAMPLE11ABCDEFG0example5of9_2nVwvsylpmOLboQwTPTLewDcE621dQ0AAaBBCCDDEEFFHH";
  ...
  it("should handle tokens in code blocks", () => {
    const content = `\`\`\`bash
export GITHUB_TOKEN=ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW
\`\`\``;
    const expected = `\`\`\`bash
...
\`\`\``;
  ...
  it("should handle multiple tokens in one text", () => {
    const content =
      "Token 1: ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW and token 2: gho_EXAMPLE16C7e42F292c6912E7710c838347Ae178B4a";
  ...
  it("should handle tokens in URLs", () => {
    const content =
      "https://api.github.com/user?access_token=ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW";
    expect(redactGitHubTokens(content)).toBe(
...
describe("sanitizeContent with token redaction", () => {
  it("should redact tokens as part of full sanitization", () => {
    const content = `
      <!-- Hidden comment with token: ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW -->
      Here's some text with a token: gho_EXAMPLE16C7e42F292c6912E7710c838347Ae178B4a
    ...
    expect(sanitized).not.toContain(
      "ghp_EXAMPLExz7yzju2SZjGPa0dUNMAx0SH4xDOCS31LXQW",
    );
    expect(sanitized).not.toContain(
      "gho_EXAMPLE16C7e42F292c6912E7710c838347Ae178B4a",
    );
